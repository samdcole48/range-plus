...
/**
 * The Starter — 18-hole classic course.
 * Hole definitions are self-contained here to avoid circular dependencies.
 ...
 */
export const THE_STARTER_HOLES: HoleDefinition[] = [
  ...
  // Gentle dogleg right, wide and friendly. Water on the right side.
  {
    ...
    fairwayBoundary: {
      // Slight-curve right: middle section bows right (midCenter≈224, absMidDev≈24)
      points: [
        { x: 175, y: 30 }, { x: 228, y: 30 },
        { x: 238, y: 60 }, { x: 235, y: 90 },
        { x: 240, y: 140 }, { x: 258, y: 210 },
        { x: 278, y: 290 }, { x: 274, y: 375 },
        { x: 260, y: 445 }, { x: 248, y: 500 },
        { x: 238, y: 548 }, { x: 228, y: 578 },
        { x: 172, y: 578 }, { x: 164, y: 548 },
        { x: 152, y: 500 }, { x: 155, y: 445 },
        { x: 170, y: 375 }, { x: 175, y: 290 },
        { x: 170, y: 210 }, { x: 162, y: 140 },
  ...
  // Split fairway with two landing areas separated by bunker/rough complex.
  {
    ...
    fairwayBoundary: {
      // S-curve: top swings RIGHT (covers green x=169-232), bottom swings LEFT
      // topDev≈+16 (>15), bottomDev≈-24 (<-15), signs opposite → S-CURVE
      points: [
        { x: 165, y: 38 }, { x: 285, y: 38 },
        { x: 285, y: 70 }, { x: 280, y: 105 },
        { x: 268, y: 165 }, { x: 255, y: 230 },
        { x: 238, y: 295 }, { x: 230, y: 370 },
        { x: 225, y: 440 }, { x: 218, y: 500 },
        { x: 210, y: 545 }, { x: 205, y: 578 },
        { x: 178, y: 578 }, { x: 172, y: 545 },
        { x: 162, y: 500 }, { x: 148, y: 440 },
        { x: 115, y: 370 }, { x: 105, y: 295 },
        { x: 120, y: 230 }, { x: 140, y: 165 },
        { x: 155, y: 105 }, { x: 160, y: 70 },
      ],
    },
    waterHazards: [{
      boundary: {
  ...
  // Short, driveable par 4. Risk/reward in purest form.
  {
    ...
    fairwayBoundary: {
      // Slight-curve left: middle shifts left (midCenter≈177, absMidDev≈23)
      points: [
        { x: 174, y: 55 }, { x: 226, y: 55 },
        { x: 228, y: 90 }, { x: 226, y: 120 },
        { x: 224, y: 180 }, { x: 216, y: 250 },
        { x: 210, y: 320 }, { x: 215, y: 385 },
        { x: 220, y: 440 }, { x: 216, y: 490 },
        { x: 212, y: 530 }, { x: 208, y: 545 },
        { x: 192, y: 545 }, { x: 188, y: 530 },
        { x: 184, y: 490 }, { x: 178, y: 440 },
        { x: 142, y: 385 }, { x: 138, y: 320 },
        { x: 145, y: 250 }, { x: 168, y: 180 },
        { x: 172, y: 120 }, { x: 172, y: 90 },
      ],
    },
    waterHazards: [{
  ...
  // S-curve fairway winding through trees. Creek crosses mid-fairway.
  {
    ...
    fairwayBoundary: {
      // S-curve: top shifts LEFT (contains green x=168-237), bottom shifts RIGHT
      // topDev≈-17.8 (<-15), bottomDev≈+15.8 (>+15), signs opposite → S-CURVE
      points: [
        { x: 100, y: 32 }, { x: 242, y: 32 },
        { x: 246, y: 65 }, { x: 242, y: 98 },
        { x: 230, y: 148 }, { x: 222, y: 198 },
        { x: 238, y: 255 }, { x: 265, y: 315 },
        { x: 288, y: 368 }, { x: 280, y: 422 },
        { x: 265, y: 475 }, { x: 250, y: 525 },
        { x: 238, y: 558 }, { x: 230, y: 578 },
        { x: 170, y: 578 }, { x: 162, y: 558 },
        { x: 155, y: 525 }, { x: 150, y: 475 },
        { x: 148, y: 422 }, { x: 138, y: 368 },
        { x: 118, y: 315 }, { x: 108, y: 255 },
        { x: 105, y: 198 }, { x: 100, y: 148 },
        { x: 96, y: 98 },
      ],
    },
    waterHazards: [{
  ...
  // Elevated tee, fairway narrows at landing zone, bunkers guarding green.
  {
    ...
    fairwayBoundary: {
      // Slight-curve right: middle shifts right (midCenter≈223, absMidDev≈21.5)
      points: [
        { x: 167, y: 35 }, { x: 222, y: 35 },
        { x: 228, y: 65 }, { x: 226, y: 95 },
        { x: 232, y: 155 }, { x: 255, y: 210 },
        { x: 278, y: 295 }, { x: 274, y: 378 },
        { x: 250, y: 445 }, { x: 238, y: 500 },
        { x: 228, y: 550 }, { x: 218, y: 578 },
        { x: 182, y: 578 }, { x: 172, y: 550 },
        { x: 162, y: 500 }, { x: 162, y: 445 },
        { x: 168, y: 378 }, { x: 172, y: 295 },
        { x: 170, y: 210 }, { x: 170, y: 155 },
        { x: 178, y: 95 }, { x: 162, y: 65 },
      ],
    },
    waterHazards: [],
    bunkers: [
  ...
  // Wide fairway with risk/reward second shot over water to reach green in two.
  {
    ...
    fairwayBoundary: {
      // Dogleg left: middle shifts left (midCenter≈158, absMidDev≈42). vtx0 angle fixed.
      // Upper section is wider (maxX=268) so right-side trees stay within CHG-YRD-001 threshold.
      points: [
        { x: 158, y: 25 }, { x: 265, y: 25 },
        { x: 268, y: 55 }, { x: 265, y: 90 },
        { x: 258, y: 145 }, { x: 242, y: 175 },
        { x: 218, y: 215 }, { x: 210, y: 295 },
        { x: 208, y: 380 }, { x: 218, y: 450 },
        { x: 232, y: 510 }, { x: 228, y: 555 },
        { x: 222, y: 580 }, { x: 178, y: 580 },
        { x: 172, y: 555 }, { x: 165, y: 510 },
        { x: 155, y: 450 }, { x: 100, y: 380 },
        { x: 98, y: 295 }, { x: 105, y: 215 },
        { x: 128, y: 175 }, { x: 145, y: 145 },
        { x: 152, y: 90 }, { x: 155, y: 55 },
      ],
    },
    waterHazards: [{
      boundary: {
  ...
  // Tight fairway lined with trees, premium on accuracy.
  {
    ...
    fairwayBoundary: {
      // Slight-curve left: middle shifts left (midCenter≈176, absMidDev≈26.5)
      points: [
        { x: 174, y: 40 }, { x: 232, y: 40 },
        { x: 234, y: 70 }, { x: 232, y: 100 },
        { x: 226, y: 160 }, { x: 214, y: 220 },
        { x: 208, y: 300 }, { x: 212, y: 380 },
        { x: 218, y: 445 }, { x: 222, y: 500 },
        { x: 220, y: 548 }, { x: 218, y: 575 },
        { x: 182, y: 575 }, { x: 180, y: 548 },
        { x: 175, y: 500 }, { x: 172, y: 445 },
        { x: 142, y: 380 }, { x: 138, y: 300 },
        { x: 145, y: 220 }, { x: 158, y: 160 },
  ...
  // Signature closing hole, long and challenging with bunkers and water.
  {
    ...
    fairwayBoundary: {
      // Slight-curve right: vtx0 moved to fix angle, middle shifts right (midCenter≈220, absMidDev≈22.5)
      points: [
        { x: 168, y: 26 }, { x: 228, y: 26 },
        { x: 235, y: 55 }, { x: 238, y: 90 },
        { x: 250, y: 160 }, { x: 262, y: 230 },
        { x: 272, y: 300 }, { x: 268, y: 375 },
        { x: 256, y: 445 }, { x: 242, y: 500 },
        { x: 232, y: 548 }, { x: 225, y: 580 },
        { x: 175, y: 580 }, { x: 168, y: 548 },
        { x: 158, y: 500 }, { x: 155, y: 445 },
        { x: 168, y: 375 }, { x: 175, y: 300 },
        { x: 170, y: 230 }, { x: 162, y: 160 },
