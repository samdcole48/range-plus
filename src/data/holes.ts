...
export const PRESET_HOLES: HoleDefinition[] = [
  ...
  // Gentle dogleg right, wide and friendly. Water on the right side.
  {
    ...
    trees: [
      ...
      { position: { x: 70, y: 200 }, radius: 12 },
      { position: { x: 75, y: 280 }, radius: 14 },
      { position: { x: 65, y: 360 }, radius: 10 },
      { position: { x: 85, y: 430 }, radius: 16 },
      { position: { x: 370, y: 100 }, radius: 11 },
      { position: { x: 360, y: 180 }, radius: 13 },
      { position: { x: 355, y: 310 }, radius: 14 },
      { position: { x: 375, y: 420 }, radius: 10 },
      { position: { x: 345, y: 500 }, radius: 12 },
  ...
  // Diagonal water from lower-left to upper-right. Risk-reward off the tee.
  {
    ...
    trees: [
      ...
      { position: { x: 370, y: 210 }, radius: 13 },
      { position: { x: 355, y: 330 }, radius: 12 },
      { position: { x: 365, y: 440 }, radius: 14 },
      { position: { x: 55, y: 545 }, radius: 9 },
      { position: { x: 380, y: 530 }, radius: 10 },
  ...
  // Pebble Beach inspired. Green juts into water on three sides.
  {
    ...
    trees: [
      ...
      { position: { x: 365, y: 450 }, radius: 14 },
      { position: { x: 55, y: 540 }, radius: 9 },
      { position: { x: 380, y: 540 }, radius: 10 },
      { position: { x: 150, y: 22 }, radius: 12 },
      { position: { x: 260, y: 22 }, radius: 11 },
  ...
  // Short, driveable par 4. Risk/reward in purest form.
  {
    ...
    trees: [
      ...
      { position: { x: 68, y: 80 }, radius: 16 },
      { position: { x: 58, y: 190 }, radius: 12 },
      { position: { x: 76, y: 310 }, radius: 14 },
      { position: { x: 62, y: 420 }, radius: 10 },
      { position: { x: 78, y: 490 }, radius: 16 },
      { position: { x: 362, y: 95 }, radius: 11 },
      { position: { x: 370, y: 225 }, radius: 13 },
      { position: { x: 355, y: 355 }, radius: 12 },
      { position: { x: 368, y: 465 }, radius: 14 },
      { position: { x: 53, y: 545 }, radius: 9 },
      { position: { x: 378, y: 545 }, radius: 10 },
  ...
  // Long par 3. Water entire left side, bunkers right.
  {
    ...
    trees: [
      ...
      { position: { x: 58, y: 200 }, radius: 12 },
      { position: { x: 76, y: 320 }, radius: 16 },
      { position: { x: 62, y: 430 }, radius: 10 },
  ...
  // S-curve fairway winding through trees. Creek crosses mid-fairway.
  {
    ...
    trees: [
      ...
      { position: { x: 70, y: 80 }, radius: 16 },
      { position: { x: 60, y: 175 }, radius: 12 },
      { position: { x: 78, y: 285 }, radius: 14 },
      { position: { x: 65, y: 385 }, radius: 10 },
      { position: { x: 80, y: 470 }, radius: 16 },
      { position: { x: 360, y: 90 }, radius: 11 },
      { position: { x: 372, y: 205 }, radius: 13 },
      { position: { x: 358, y: 325 }, radius: 12 },
      { position: { x: 368, y: 435 }, radius: 14 },
      { position: { x: 55, y: 545 }, radius: 9 },
      { position: { x: 380, y: 545 }, radius: 10 },
      { position: { x: 148, y: 22 }, radius: 12 },
      { position: { x: 258, y: 22 }, radius: 11 },
  ...
  // Long, demanding finisher. Water left side, semi-peninsula green.
  {
    ...
    trees: [
      ...
      { position: { x: 68, y: 80 }, radius: 16 },
      { position: { x: 60, y: 185 }, radius: 12 },
      { position: { x: 76, y: 295 }, radius: 14 },
      { position: { x: 62, y: 395 }, radius: 10 },
      { position: { x: 78, y: 465 }, radius: 16 },
      { position: { x: 360, y: 95 }, radius: 11 },
      { position: { x: 370, y: 215 }, radius: 13 },
      { position: { x: 355, y: 345 }, radius: 12 },
      { position: { x: 368, y: 445 }, radius: 14 },
      { position: { x: 53, y: 545 }, radius: 9 },
      { position: { x: 378, y: 545 }, radius: 10 },
      { position: { x: 150, y: 22 }, radius: 12 },
  ...
  // Elevated tee, fairway narrows at landing zone, bunkers guarding green.
  {
    ...
    trees: [
      ...
      { position: { x: 68, y: 80 }, radius: 16 },
      { position: { x: 58, y: 175 }, radius: 12 },
      { position: { x: 76, y: 275 }, radius: 14 },
      { position: { x: 62, y: 375 }, radius: 10 },
      { position: { x: 78, y: 460 }, radius: 16 },
      { position: { x: 360, y: 90 }, radius: 11 },
      { position: { x: 370, y: 210 }, radius: 13 },
      { position: { x: 355, y: 340 }, radius: 12 },
      { position: { x: 368, y: 450 }, radius: 14 },
      { position: { x: 53, y: 545 }, radius: 9 },
  ...
  // Coastal-inspired par 3 with water left, bunkers right.
  {
    ...
    trees: [
      ...
      { position: { x: 125, y: 450 }, radius: 13 },
      { position: { x: 40, y: 70 }, radius: 16 },
      { position: { x: 35, y: 160 }, radius: 12 },
      { position: { x: 45, y: 260 }, radius: 14 },
      { position: { x: 38, y: 370 }, radius: 10 },
      { position: { x: 48, y: 460 }, radius: 16 },
      { position: { x: 365, y: 80 }, radius: 11 },
      { position: { x: 375, y: 195 }, radius: 13 },
      { position: { x: 360, y: 315 }, radius: 12 },
      { position: { x: 370, y: 430 }, radius: 14 },
      { position: { x: 35, y: 545 }, radius: 9 },
      { position: { x: 378, y: 540 }, radius: 10 },
      { position: { x: 148, y: 22 }, radius: 12 },
      { position: { x: 258, y: 22 }, radius: 11 },
      { position: { x: 385, y: 130 }, radius: 8 },
      { position: { x: 30, y: 110 }, radius: 13 },
      { position: { x: 388, y: 560 }, radius: 10 },
      { position: { x: 28, y: 510 }, radius: 9 },
      { position: { x: 392, y: 370 }, radius: 11 },
      { position: { x: 20, y: 300 }, radius: 10 },
  ...
  // Wide fairway with risk/reward second shot over water to reach green in two.
  {
    ...
    trees: [
      ...
      { position: { x: 68, y: 80 }, radius: 16 },
      { position: { x: 58, y: 180 }, radius: 12 },
      { position: { x: 76, y: 285 }, radius: 14 },
      { position: { x: 62, y: 385 }, radius: 10 },
      { position: { x: 78, y: 465 }, radius: 16 },
      { position: { x: 360, y: 95 }, radius: 11 },
      { position: { x: 370, y: 215 }, radius: 13 },
      { position: { x: 355, y: 345 }, radius: 12 },
  ...
  // Dogleg left with water hazard along the inside of the turn.
  {
    ...
    trees: [
      ...
      { position: { x: 40, y: 80 }, radius: 16 },
      { position: { x: 35, y: 175 }, radius: 12 },
      { position: { x: 45, y: 280 }, radius: 14 },
      { position: { x: 38, y: 380 }, radius: 10 },
      ...
      { position: { x: 35, y: 540 }, radius: 9 },
      { position: { x: 378, y: 540 }, radius: 10 },
      { position: { x: 148, y: 22 }, radius: 12 },
      { position: { x: 258, y: 22 }, radius: 11 },
      { position: { x: 385, y: 145 }, radius: 8 },
      { position: { x: 28, y: 120 }, radius: 13 },
      { position: { x: 388, y: 560 }, radius: 10 },
      { position: { x: 30, y: 510 }, radius: 9 },
      { position: { x: 392, y: 375 }, radius: 11 },
      { position: { x: 22, y: 305 }, radius: 10 },
